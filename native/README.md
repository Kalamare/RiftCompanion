...
Premier socle C# / .NET 10 LTS + WPF + SQLite. Le SDK officiel a été installé localement dans `.tools/dotnet` à la racine du dépôt.
...
5. Comparer LoL seul puis avec WPF, fenêtres visible et masquée, selon le protocole du plan. Ne pas faire tourner aussi le prototype Node pendant la mesure A/B.
