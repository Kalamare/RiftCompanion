...
En v31, le lancement optionnel `Lancer-Serveur-Local.cmd` utilise le [backend Docker](../server/README.md) : profils/historique/détails servis par API, agrégats saisonniers calculés sur le serveur et notifications SignalR. Le champ clé Riot et la synchronisation manuelle disparaissent dans ce mode. Le lancement local ci-dessous reste disponible pendant la migration.
...
Connexion et préférences : implémentées. Profil individuel : première version avec démonstration, API Riot et cache SQLite ; validation réelle à faire. Voir ../docs/PROFIL-JOUEUR.md. Recommandations et équipement : différés. Pas d'automatisation du jeu ni de capture vidéo. Overlay natif : voir ../docs/OVERLAY.md.
